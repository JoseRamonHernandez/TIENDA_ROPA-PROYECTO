...
<form  action="usuariosBusqueda.php" method="GET">
<div class="container-lg">Buscar</div>
    <center>
    <div class="input-group mb-3">
 
  <input type="text" class="form-control" name="buscar" placeholder="Buscar Empleado por (  Username o Codigo-Empleado)" aria-label="Example text with button addon" aria-describedby="button-addon1">
</div>
    </center>
</form>
</div>
...
<table class="table">
    ...
    <?php
    $consulta= "SELECT id, nombre, apellido, correo, username, telefono, domicilio, puesto FROM empleados";
