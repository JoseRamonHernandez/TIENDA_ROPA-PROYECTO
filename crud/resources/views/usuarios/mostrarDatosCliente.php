...
<form  action="clientesBusqueda.php" method="GET">
<div class="container-lg">Buscar</div>
    <center>
    <div class="input-group mb-3">
 
  <input type="text" class="form-control" name="buscar" placeholder="Username del Cliente" aria-label="Example text with button addon" aria-describedby="button-addon1">
</div>
    </center>
</form>
</div>
